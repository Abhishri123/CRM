            ...
            <div class="row">
              <div class="col-lg-6 bg-white">
                <div class="auth-form-light text-left p-5">
                  <h2>Login</h2>
                  <h4 class="font-weight-light">Welcome to our CRM system</h4>
                  <form class="pt-5" action="{{url('admin/check_user')}}" method="post">
                    ...
                    <div class="mt-5">
                      ...
                      <input type="submit" class="btn btn-block btn-success btn-lg font-weight-medium" value="Login" style="background-color:#9D50D6"/>
                    </div>
